...
let UserNotAuthorizedError = function (message) {
    this._name = 'UserNotAuthorizedError';
    this._message = message || 'User is not authorized to perform this action';
    this._statusCode = 403;
};

UserNotAuthorizedError.prototype = {
    get type() {
        return this._name;
    },
    get message() {
...
module.exports.UserNotAuthorizedError = UserNotAuthorizedError;
